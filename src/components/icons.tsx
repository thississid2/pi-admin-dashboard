...
export const ShieldAlert = ({ className }: { className?: string }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 1l8.25 4.5v6.75a8.25 8.25 0 01-16.5 0V5.5L12 1z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const Key = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M10.85 12.15l8.3-8.3a2.1 2.1 0 013 3l-8.3 8.3"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const UserShield = ({ className }: { className?: string }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
